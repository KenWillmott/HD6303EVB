...
NIBBLE	equ	*
	...
	adda	#$F+1-9
	bcs	NIB2	if not 0->$F
NIB1	adda	#$0A	convert ASCII to binary
	clc		clear carry
NIB2	rts
...
*	xgdx		swap upper/lower
	fcb	$18	6303 only instruction
...
CMP32	equ	*
	cpx	CMT	compare x with CMT+3, CMT+2
	bne	CMP1	if equal {
*	xgdx		swap X/ACCD
	fcb	$18	6303 only instruction
